...
for iteration in range(1, 1000):
    ...
    model.reset_states()
    i = 0
    model.fit_generator(generate_training_data(text, char_indices), samples_per_epoch=1024 * 1024 * 2, nb_epoch=1)
